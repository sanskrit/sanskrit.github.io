+++
title = "kANe instructions"
+++

Are you interested in proofreading kANe's history of dharmashAstra (lots of sanskrit footnotes)?  
Example of a proofread page, presented on the net - [TW](https://vishvasa.github.io/kalpAntaram/dharmaH/nibandhaH/en/kANe/history/v1p1/02_sources_of_dharma/)  
Source book images - https://sanatana.in/dharmashastra/Volumes

Let's take https://github.com/vishvAsa/kalpAntaram/blob/content/dharmaH/nibandhaH/en/kANe/history/v1p1/07_dharmasUtra_of_Apastamba.md as an example.

You should go to https://aistudio.google.com/ , accept all permissions, connect to google drive etc.. .  
Then you should give it some appropriate instruction ( sent in the next message).   
Then you should page one page at a time.  
You will get some output.  
Then you should carefully check and edit the output you get to match the page image.

Having done it for all pages in the chapter, you should send me the finished file.
